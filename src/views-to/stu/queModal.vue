<template>
      ...
      <dl>
        ...
        <dd class="content">
            ...
            <div class="btn_areaC mt30">
                ...
                <a href="" @click.prevent="quemodalclose()" class="btnType gray"  id="btnClose" name="btn"><span>취소</span></a>
    ...
    <a href="" class="closePop" @click.prevent="quemodalclose()"><span class="hidden">닫기</span></a>
