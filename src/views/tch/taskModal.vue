                ...
                <table class="row">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" class="inputTxt p100" name="taskname" id="taskname" v-model="taskname" /></td>
                        </tr>
                        <tr>
                            <th>과제 내용 <span class="font_red">*</span></th>
                            <td><input type="text" class="inputTxt p100" name="taskprob" id="taskprob" v-model="taskprob"/></td>
                        </tr>
                        <tr>
                            <th>시작일자 <span class="font_red">*</span></th>
                            <td><input type="date" class="inputTxt p100" name="taskst" id="taskst" v-model="taskst"/></td>
                        </tr>
                        <tr>
                            <th>마감일자 <span class="font_red">*</span></th>
                            <td><input type="date" class="inputTxt p100" name="tasked" id="tasked" v-model="tasked"/></td>
                        </tr>
                    </tbody>
                </table>
                <div class="btn_areaC mt30">
                    <a href="" class="btnType blue" id="btnSavetask" name="btn" @click.prevent="tasksave()"><span>저장</span></a>
                </div>
            </dd>
        </dl>
    </div>
